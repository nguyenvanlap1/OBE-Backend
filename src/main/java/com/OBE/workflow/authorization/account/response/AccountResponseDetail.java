package com.OBE.workflow.authorization.account.response;

import com.OBE.workflow.authorization.account.Account; // Giả sử đây là path của Entity
import com.OBE.workflow.authorization.account.account_role_sub_department.AccountRoleSubDepartmentResponse;
import lombok.*;
